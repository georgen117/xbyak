...
enum {
	...
	// Register manager errors:
	ERR_RM_GP_IN_USE,
	ERR_RM_GP_NOT_IN_USE,
	ERR_RM_GP_NOT_AVAILABLE,
	ERR_RM_NO_FREE_GP,
	ERR_RM_VEC_IN_USE,
	ERR_RM_VEC_NOT_IN_USE,
	ERR_RM_VEC_NOT_AVAILABLE,
	ERR_RM_NO_FREE_VEC,
	ERR_RM_OPMASK_IN_USE,
	ERR_RM_OPMASK_NOT_IN_USE,
	ERR_RM_OPMASK_NOT_AVAILABLE,
	ERR_RM_NO_FREE_OPMASK,
	ERR_RM_TILE_IN_USE,
	ERR_RM_TILE_NOT_IN_USE,
	ERR_RM_TILE_NOT_AVAILABLE,
	ERR_RM_NO_FREE_TILE,
	ERR_RM_REG_IDX_OUT_OF_RANGE,
...
inline const char *ConvertErrorToString(int err)
{
	static const char *errTbl[] = {
		...
		// Register manager error strings:
